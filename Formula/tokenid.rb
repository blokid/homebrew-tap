...
class Tokenid < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/blokid/homebrew-tap/releases/download/cli-v1.0.0/tokenid-darwin-arm64"
      sha256 "0096ad3e9d4da4b9f919401d8d821e01022f5239a2e724184a0859759c0e2d2a"
    end
    on_intel do
      url    "https://github.com/blokid/homebrew-tap/releases/download/cli-v1.0.0/tokenid-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url    "https://github.com/blokid/homebrew-tap/releases/download/cli-v1.0.0/tokenid-linux-arm64"
      sha256 "5f65ed51c0f2830b327befb56bfe442f558068bfd4bbd6cc79e38035be21d9bf"
    end
    on_intel do
      url    "https://github.com/blokid/homebrew-tap/releases/download/cli-v1.0.0/tokenid-linux-amd64"
